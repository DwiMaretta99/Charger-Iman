...
public class quran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                List<Item> listData = new QuranDAO(quran.this).getListDataWhereCriteria("SuratID", pos + 1);
                String[] ayat = new String[listData.size()];
                for (int j = 0; j < listData.size(); j++) {
                    ayat[j] = listData.get(j).getAyatText();
                }

                Adapter adapter = new Adapter(quran.this, R.layout.item, listData);
    ...
    class doBackground extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            insertFromFile(quran.this, R.raw.quran);
            return null;
        }
